...
(async () => {
  ...
  console.log(`Testing deriva...`);
  await page.click(`#tab-deriva`);
  await new Promise(r => setTimeout(r, 10000));
  const sizes = await page.evaluate(() => {
    const el = document.getElementById('deriva-canvas');
  ...
  await page.screenshot({ path: '/Users/andy/.gemini/antigravity/brain/853399b6-d641-4447-8deb-3c27042ebc33/screenshot_deriva_page.png' });
